...
% rf = RfDataFilt(1:2048,105:360);clear RfDataFilt;
% D1 = 256.*(rf./max(rf(:)));
...
uni_err = uni_err/8
jit_err_1d = jit_err_1d/8
jit_err_2d = jit_err_2d/8
...
figure; imagesc(y);colormap gray;axis square;axis off
figure; imagesc(y1);colormap gray;axis square;axis off
figure; imagesc(y2);colormap gray;axis square;axis off
figure; imagesc(y3);colormap gray;axis square;axis off